...
-- am_ant_sys
-- load am_ant_sys
LOAD DATA LOCAL INFILE '/root/cdbs/am_ant_sys.dat'
...
-- load am_augs
LOAD DATA LOCAL INFILE '/root/cdbs/am_augs.dat'
INTO TABLE am_augs
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '^|\n'
...
-- am_eng_data
-- load am_eng_data
LOAD DATA LOCAL INFILE '/root/cdbs/am_eng_data.dat'
...
-- am_towers
-- load am_towers
LOAD DATA LOCAL INFILE '/root/cdbs/am_towers.dat'
...
-- amcmnts
-- load amcmnts
LOAD DATA LOCAL INFILE '/root/cdbs/amcmnts.dat'
INTO TABLE amcmnts
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '^|\n'
...
-- ant_make
-- load ant_make
LOAD DATA LOCAL INFILE '/root/cdbs/ant_make.dat'
INTO TABLE ant_make
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '^|\n'
...
-- ant_pattern
-- load ant_pattern
LOAD DATA LOCAL INFILE '/root/cdbs/ant_pattern.dat'
...
-- app_party
-- load app_party
LOAD DATA LOCAL INFILE '/root/cdbs/app_party.dat'
...
-- app_tracking
-- load app_tracking
LOAD DATA LOCAL INFILE '/root/cdbs/app_tracking.dat'
...
-- application
-- load application
LOAD DATA LOCAL INFILE '/root/cdbs/application.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/call_sign_history.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/dtv_agreement_group.dat'
...
-- dtv_allotment
-- load dtv_allotment
LOAD DATA LOCAL INFILE '/root/cdbs/dtv_allotment.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/dtv_channel_assignments.dat'
...
-- dtv_facility
-- load dtv_facility
LOAD DATA LOCAL INFILE '/root/cdbs/dtv_facility.dat'
...
-- dtv_transition
-- load dtv_transition
LOAD DATA LOCAL INFILE '/root/cdbs/dtv_transition.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/elevation_ant_make.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/elevation_pattern.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/elevation_pattern_addl.dat'
...
-- fac_party
-- load fac_party
LOAD DATA LOCAL INFILE '/root/cdbs/fac_party.dat'
...
-- facility
-- load facility
LOAD DATA LOCAL INFILE '/root/cdbs/facility.dat'
INTO TABLE facility
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '^|\n'
...
LOAD DATA LOCAL INFILE '/root/cdbs/fm_app_indicators.dat'
...
-- fm_eng_data
-- load fm_eng_data
LOAD DATA LOCAL INFILE '/root/cdbs/fm_eng_data.dat'
...
-- frn_history
-- load frn_history
LOAD DATA LOCAL INFILE '/root/cdbs/frn_history.dat'
...
-- fmcmnts
-- load fmcmnts
LOAD DATA LOCAL INFILE '/root/cdbs/fmcmnts.dat'
INTO TABLE fmcmnts
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '^|\n'
(application_id, comment_type, comment);
...
LOAD DATA LOCAL INFILE '/root/cdbs/gen_app_indicators.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/if_notification.dat'
...
-- int_translator
-- load int_translator
LOAD DATA LOCAL INFILE '/root/cdbs/int_translator.dat'
...
-- intl_tracking
-- load intl_tracking
LOAD DATA LOCAL INFILE '/root/cdbs/intl_tracking.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/lic_app_indicators.dat'
...
-- nce_factors
-- load nce_factors
LOAD DATA LOCAL INFILE '/root/cdbs/nce_factors.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_capitalization.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_contract.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_exemptions.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_group.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_interests.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_other_int.dat'
...
-- ERROR 2 (HY000): File '/root/cdbs/ownership_other_int_xml_data.dat' not found (Errcode: 2)
-- ownership_other_int_xml_data
-- load ownership_other_int_xml_data
-- LOAD DATA LOCAL INFILE '/root/cdbs/ownership_other_int_xml_data.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_relationships.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_report.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/ownership_structure.dat'
...
-- party
-- load party
LOAD DATA LOCAL INFILE '/root/cdbs/party.dat'
INTO TABLE party
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '^|\n'
...
-- positional_int
-- load positional_int
LOAD DATA LOCAL INFILE '/root/cdbs/positional_int.dat'
...
-- supp_facility
-- load supp_facility
LOAD DATA LOCAL INFILE '/root/cdbs/supp_facility.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/tv_app_indicators.dat'
...
-- tv_eng_data
-- load tv_eng_data
LOAD DATA LOCAL INFILE '/root/cdbs/tv_eng_data.dat'
...
LOAD DATA LOCAL INFILE '/root/cdbs/docs/Attributes_tab.txt'
